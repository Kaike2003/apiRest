    ...
    protected async login_admin(req: Request, res: Response) {
        ...
        Schema_login_admin.parseAsync({
            ...
            if (!result_email) {
                ...
                if (result_email.email === sucesso_validacao.email && result_email.tipo_utilizador === "ADMIN") {
                    ...
                    if (senha_correta === true && result_email.autenticado === "TRUE" && result_email.banido === "FALSE" && result_email.tipo_utilizador === "ADMIN") {
